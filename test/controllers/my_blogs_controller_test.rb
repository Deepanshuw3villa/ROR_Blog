...
class MyBlogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create my_blog" do
    assert_difference('MyBlog.count') do
      post my_blogs_url, params: { my_blog: { body: @my_blog.body, category: @my_blog.category, title: @my_blog.title } }
    end
  ...
  test "should update my_blog" do
    patch my_blog_url(@my_blog), params: { my_blog: { body: @my_blog.body, category: @my_blog.category, title: @my_blog.title } }
